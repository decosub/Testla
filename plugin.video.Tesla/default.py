...
if mode==None:
    ...
    line1 = "                 [B][COLOR lime]Todo el Contenido de Addon Procede de YouTube [/COLOR][/B]"
    line2 = "                [B][COLOR lime]Bienvenidos al Mundo de la Ciencia y la Fisica... [/COLOR][/B]"
    line3 = "                   [B][COLOR lime]Exploremos los limites de la Fisica.[/COLOR][/B]"
